...
class AddUserComponent extends Component {
    ...
    handleSubmit(values) {
        ...
        // console.log("Created User: " + JSON.stringify(values));
        // alert("Created User: " + JSON.stringify(values));
    }
                                    ...
                                    <div style={props} className="card col-md-6">
                                        <div className="card-body">
                                            <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                                                <Alert isOpen={this.state.hasAddUserFailed} toggle={this.onDismiss} color="danger">
                                                    Some error occured!
                                                </Alert>
